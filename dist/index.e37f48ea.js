...
const showRecipe = async function() {
    try {
      ...
      <figure class="recipe__fig">
        <img src="${recipe.image}" alt="T${recipe.title}" class="recipe__img" />
...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/task":"7jDg7"}],"cMpiy":[function(require,module,exports) {
